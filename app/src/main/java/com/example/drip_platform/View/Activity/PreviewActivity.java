        ...
        bottomNavigationView.setOnNavigationItemSelectedListener((item) -> {
            switch (item.getItemId()) {
                ...
                case R.id.action_home:
                    Intent intent3 =new Intent(PreviewActivity.this, GoogleMapActivity.class);
                    startActivity(intent3);
                    finish();
                    break;
                case R.id.action_device:
                    Intent intent =new Intent(PreviewActivity.this, EquipmentInfoActivity.class);
                    startActivity(intent);
                    finish();
                    break;
                case R.id.action_personal:
                    Intent intent2 =new Intent(PreviewActivity.this, PersonalActivity.class);
...
public void onMapReady(com.google.android.gms.maps.GoogleMap googleMap) {
    ...
    public void Number_value(){
        ...
        try {
            ...
            AlertDialog.Builder adbATM = new AlertDialog.Builder(PreviewActivity.this);
            adbATM.setTitle("警告");
                    ...
                    btOK.setOnClickListener((v1 -> {
                        ...
                        if(!editText.getText().toString().matches("")) {
                            if(Integer.valueOf(editText.getText().toString())<=99999) {
                                ...
                                AlertDialog.Builder twoDialog = new AlertDialog.Builder(PreviewActivity.this);
